...
if ~ismember(quadrature_rank,[4,6])
    error('This bounded paper-side rank study supports only GL4 and GL6.');
end
...
outer_node_diagnostics = repmat(struct( ...
    ...
    'increment_spectrum_max',0),1,quadrature_rank);
for outer_index = 1:quadrature_rank
...
audit = struct( ...
    ...
    'outer_quadrature_rank',quadrature_rank, ...
    'inner_scale',lambda2, ...
    'outer_scale',lambda3, ...

...
line_style(ax4,display_window*[-1 1],[-field_limit field_limit], ...
    ...
    '$\widehat{\eta}_{22}\equiv\eta_{22}/(A^2k_p)$');
...
line_style(ax5,display_window*[-1 1], ...
    ...
    sprintf('(e) Difference; $L_2=%.3f\\%%$',100*raw_l2), ...
    '$100\,\Delta\eta_{22}/\max|\eta_{22}^{\mathrm{MF12}}|\;(\%)$');
...
close(fig);
fprintf('GL6_WAVEFORM_COMPLETE cross=120 spread=30 L2=%.9g%% %s\n', ...
    100*raw_l2,output_path);
end
